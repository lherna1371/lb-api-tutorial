...
async function callAPI() {
    ...
    let characterData = await (0, _rickmortyapi.getCharacter)(characterID);
    ...
    } else console.log("Character Status is Unkown!!!");
}

},{"rickmortyapi":"5Cka1"}],"5Cka1":[function(require,module,exports) {
"use strict";
...
var L = (e, t)=>{
    ...
    if (t && typeof t == "object" || typeof t == "function") for (let s of E(t))!I.call(e, s) && s !== o && i(e, s, {
        get: ()=>t[s],
        enumerable: !(n = A(t, s)) || n.enumerable
    });
    return e;
};
var F = (e)=>C(i({}, "__esModule", {
        value: !0
    }), e);
var $ = {};
L($, {
...
}, a = (e)=>typeof e == "number" && Number.isInteger(e), y = (e)=>Array.isArray(e) && e.every(a), P = (e, t)=>{
    if (t && a(e)) return `/${e}`;
    if (t && y(e)) {
        let o = e;
        return `/${o.length ? o : "[0]"}`;
...
var k = async ({ endpoint: e , options: t , isIdRequired: o = !1  })=>{
    let n = p(t, o);
    return c(`${e}/${n}`);
}, r = k;
var m = "character", u = (e)=>r({
        endpoint: m,
        options: e ?? {}
    }), d = (e)=>r({
        endpoint: m,
